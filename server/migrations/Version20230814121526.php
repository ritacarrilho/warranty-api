 ...
 */
final class Version20230814121526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE consumer (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, first_name VARCHAR(150) NOT NULL, last_name VARCHAR(150) NOT NULL, phone VARCHAR(80) DEFAULT NULL, UNIQUE INDEX UNIQ_705B37279D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE equipment (id INT AUTO_INCREMENT NOT NULL, category_id_id INT NOT NULL, user_id_id INT NOT NULL, name VARCHAR(150) NOT NULL, brand VARCHAR(150) NOT NULL, model VARCHAR(150) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, serial_code VARCHAR(200) NOT NULL, purchase_date DATE DEFAULT NULL, INDEX IDX_D338D5839777D11E (category_id_id), INDEX IDX_D338D5839D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE equipment ADD CONSTRAINT FK_D338D5839D86650F FOREIGN KEY (user_id_id) REFERENCES consumer (id)');
