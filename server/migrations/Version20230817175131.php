 ...
 */
final class Version20230817175131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE warranty (id INT AUTO_INCREMENT NOT NULL, equipment_id INT NOT NULL, manufacturer_id INT DEFAULT NULL, reference VARCHAR(255) NOT NULL, start_date DATE DEFAULT NULL, end_date DATE NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_88D71CF2517FE9FE (equipment_id), INDEX IDX_88D71CF2A23B42D (manufacturer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
