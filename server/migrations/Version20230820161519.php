 ...
 */
final class Version20230820161519 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE consumer (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, first_name VARCHAR(150) NOT NULL, last_name VARCHAR(150) NOT NULL, phone VARCHAR(80) DEFAULT NULL, UNIQUE INDEX UNIQ_705B3727A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE document (id INT AUTO_INCREMENT NOT NULL, warranty_id INT NOT NULL, name VARCHAR(100) NOT NULL, path VARCHAR(200) NOT NULL, INDEX IDX_D8698A762EC1782C (warranty_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE equipment (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, name VARCHAR(150) NOT NULL, brand VARCHAR(150) NOT NULL, model VARCHAR(150) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, serial_code VARCHAR(200) NOT NULL, is_active TINYINT(1) NOT NULL, purchase_date DATE DEFAULT NULL, INDEX IDX_D338D58312469DE2 (category_id), INDEX IDX_D338D583A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE warranty (id INT AUTO_INCREMENT NOT NULL, equipment_id INT NOT NULL, manufacturer_id INT DEFAULT NULL, reference VARCHAR(255) NOT NULL, start_date DATE DEFAULT NULL, end_date DATE NOT NULL, INDEX IDX_88D71CF2517FE9FE (equipment_id), INDEX IDX_88D71CF2A23B42D (manufacturer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
